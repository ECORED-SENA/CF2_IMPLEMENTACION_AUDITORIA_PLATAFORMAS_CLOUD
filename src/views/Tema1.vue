...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.fondo-1
      #t_1_1.titulo-segundo
        .h2 1.1 Tipos de servicios y modelos <i>cloud</i>
    ...
    .row.fondo-14.p-3
      .col-lg-12.mx-auto.mb-5
        .tema1-1 
          .bloque-texto-a.color-custom-3.md-5.p-3
            .row.m-0.align-items-center
              .col-lg-8(data-aos="fade-right")
                .bloque-texto-a__texto.p-3.px-md-4
                  p #[b Cada proveedor de servicios #[i cloud]  dispone de una arquitectura propia como elemento diferenciador del resto de competidores de mercado y/o para adaptarse mejor a la evolución de sus propios servicios tradicionales y necesidades de sus clientes actuales y potenciales.] 
                  p.mb-0 #[b Si bien existen diferencias marcadas entre las nubes públicas o privadas, a continuación se mencionan los diferentes componentes funcionales de alto nivel presentes en una arquitectura de nube en términos generales o genérica.]
          ...
          .col-lg-8.mb-4
            ...
            ul.lista-ul--color
              li 
                ...
                | Proporciona una interfaz común para el acceso manual y automático a las capacidades disponibles en la capa de servicios. Incluye además de las capacidades de servicio, las capacidades administrativas y comerciales.
              li
                i.fas.fa-caret-right(style="color: #FF2C9C")
    ...
    .row.justify-content-center.align-items-center.fondo-5.mb-5(data-aos="fade")
      SlyderA(tipo="b")
        .row.justify-content-evenly.align-items-center.p-4
          .col-12.col-md-4
            p Capacidades de los <b>sistemas de soporte operativo</b> (administración, monitoreo, aprovisionamiento y mantenimiento en tiempo de ejecución)
        ...
        .row.justify-content-evenly.align-items-center
          ...
          .col-12.col-md-4
            p Capacidades de los <b>sistemas de soporte empresarial</b> (catálogo de productos, facturación y gestión).
        .row.justify-content-evenly.align-items-center
          .col-12.col-md-4
            p Capacidades de los <b>sistemas de seguridad</b> (autenticación, autorización, auditoría, validación, cifrado).
          .col-12.col-md-5
            figure
        ...
        .row.justify-content-evenly.align-items-center
          ...
          .col-10.col-md-4
            p.mb-0 Capacidades de <b>integración</b> (vinculación de diferentes componentes para lograr la funcionalidad requerida).
        .row.justify-content-center.align-items-center
          .col-10.col-md-4
            p Capacidades de <b>apoyo al desarrollo </b> (que implican la creación, prueba y gestión del ciclo de vida de servicios y componentes de servicios).
          .col-12.col-md-6
            figure
    ...
    p.mb-5 La computación en la nube desde la mirada del usuario comprende el reconocimiento de algunas actividades y conceptos de los cuales debe de tener claridad, a continuación, se mencionan algunos de esos conceptos y actividades necesarias para adquirir y/o acceder a servicios ofrecidos a través de la nube.

    .row.mb-4.ps-2
      .col-8.col-lg-3.bg-color
        h3.mb-0.text-white Actividades de computación en la nube
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade") 
      .col-12.col-md-8.col-lg-12.col-xl-12
        .cajon.color-custom.p-3
          p.mb-0 Una actividad de computación en la nube se define como una búsqueda o un conjunto de tareas específicas, las cuales deben tener un propósito y generar uno o más resultados y se llevan a cabo utilizando componentes funcionales.
      ...
      .col-7.col-md-6.col-lg-3.p-2.d-flex
        .tarjeta--sencilla-1.p-4
          .row.justify-content-center.mb-3
            .col-7
              figure
                img.my-4(src='@/assets/curso/images/tema1/ico_7.svg', alt='icono-avatar')
          h3.aling Subroles Asociados
            p.text-small.aling.mt-3 Un sub-rol es un subconjunto de las actividades de computación en la nube para un rol determinado. Diferentes sub-roles pueden compartir las actividades de computación en la nube asociadas con un rol determinado.

    .row.mb-5.ps-5.fondo-3
      .col-8.col-lg-3.bg-color-4.mb-4
        h3.mb-0.text-white Partes

      .row.justify-content-center.align-items-center.mb-5(data-aos="fade")
        .col-12.col-md-8.col-lg-12.col-xl-12 
          .cajon.color-custom.p-3
            p.mb-3 Una parte es una persona física o jurídica, incorporada o no, o un grupo de ambas, conocidas como partes interesadas.
            p.mb-0 Una parte puede asumir más de un rol en cualquier momento dado y puede participar en un subconjunto específico de actividades de ese rol, una parte interesada puede ser entre otras: grandes corporaciones, pequeñas y medianas empresas, departamentos gubernamentales, instituciones académicas y ciudadanos a nivel particular.

      .row.mb-5.ps-4
        .col-8.col-lg-3.bg-color-2.mb-4
          h3.mb-0.text-white Servicios en la nube
      
        .row.justify-content-center.align-items-start.mb-4
          .col-12.col-md-4.col-lg-6.col-xl-6(data-aos="fade-right")
            .cajon.color-custom.p-3.mb-4
              p.mb-0 Los servicios en la nube son los elementos esenciales de la computación en la nube, son los diferentes tipos de capacidades ofertados por un proveedor de servicios de Cloud, en la actualidad son muchos los diferentes tipos de servicios ofertados, pero de acuerdo al estándar ISO/IEC 17788, son tres los tipos de servicios o capacidades proporcionados por el servicio en la nube, estos son:

            LineaTiempoD.color-acento-contenido.mb-4
              p(numero="1" titulo="Aplicación") Se encuentra en la capa más alta, es un servicio ofrecido bajo demanada a través de multitenencia, es accesible por medio de un navegador web, el usuario no tiene control sobre ella, y posibilita la reducción de costos de soporte y mantenimiento.
              p(numero="2" titulo="Plataforma") Aquí, el proveedor proporciona la plataforma para el desarrollo de aplicaciones, así como su mantenimiento y gestión. Es decir, ofrece todo lo que se necesita para completar el ciclo de vida y despliegue de dichas aplicaciones o servicios web. El usuario carece de control sobre la infraestructura de almacenamiento o redes.
          ...
          p.mb-5 Estos servicios fueron descritos en el componente formativo denominado “Generalidades de la Computación en la Nube” se invita a revisarlo, para recordar o profundizar estas temáticas.

    .row.mb-5.ps-2.p-text
      .col-8.col-lg-3.bg-color
        h3.mb-0.text-white Modelos de implementación en la nube
    ...
    p.mb-5 Existen algunos aspectos que se llaman transversales, porque se aplican a múltiples roles individuales o componentes funcionales, por ejemplo, la seguridad.            
    ...
    .row.mb-4.ps-2
      .col-8.col-lg-3.bg-color-2
        h3.mb-0.text-white Capas funcionales

    .row.justify-content-center.align-items-center.mb-4
      .col-12.col-md-4.col-lg-12.col-xl-12(data-aos="fade")
        .cajon.color-custom.p-3
          p.mb-3 La arquitectura funcional está segmentada en capas junto a un conjunto de funciones multicapa, cada capa representa un conjunto de componentes funcionales que proporcionan capacidades similares o tienen un propósito común.

          p.mb-0 Las siguientes cuatro capas representadas son de referencia típica, pero se debe tener en cuenta que no todas las capas o componentes funcionales requeridos están necesariamente instanciados en un sistema de computación en la nube específico:

    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")(data-aos="fade")
      .row.justify-content-center(titulo="Capa de usuario")
        .col-lg-5.px-md-3
          h4 Capa de usuario
        ...
        .col-lg-6
          figure
            img.mt-2(src='@/assets/curso/images/tema1/img_16.png' alt='')

      div.row.justify-content-center(titulo="Capa de acceso")
        .col-lg-5.px-md-3
          h4 Capa de acceso
          p Incluye componentes funcionales que facilitan la distribución de funciones y la interconexión.
        .col-lg-6
          figure
            img(src='@/assets/curso/images/tema1/img_17.png' alt='')

      .row.justify-content-center(titulo="Capa de servicio")
        .col-lg-5.px-md-3
          h4 Capa de servicio
          p Incluye componentes funcionales que proporcionan los propios servicios en la nube más las capacidades administrativas y comerciales relacionadas, y las capacidades de orquestación necesarias para realizarlos.
        .col-lg-6
            figure
              img(src='@/assets/curso/images/tema1/img_18.png' alt='')

      div.row.justify-content-center(titulo="Capa de recursos")
        .col-lg-5.px-md-3
          h4 Capa de recursos
    ...
    p Los componentes funcionales de la capa de usuario incluyen:
  .container.bg-white.fondo-16
    .row.justify-content-center.align-items-center.mb-botton
      .col-lg-10.pos-relative(data-aos="fade-right")
        .tarjeta-avatar-b.pos-relative.mb-3
          img(src='@/assets/curso/images/tema1/ico_8.svg', alt="", style="width:100px; display:block;").tj
          .tarjeta.color-tarjeta-1
            .py-4.px-md-0.px-3
              ...
              p.mb-0 En algunos casos, este componente funcional podría ser tan simple como un navegador que se ejecuta en un dispositivo de usuario. En otros casos, podría implicar un sistema empresarial sofisticado que ejecute procesos de negocio, aplicaciones, <i>middleware</i> e infraestructura asociada.
    
      .col-lg-10.pos-relative(data-aos="fade-left")
        .tarjeta-avatar-b.pos-relative.mb-3
          img(src='@/assets/curso/images/tema1/ico_9.svg', alt="", style="width:100px; display:block;").tj
          .tarjeta.color-tarjeta-1
            .py-4.px-md-0.px-3
              h4 La función comercial
              p.mb-0 Apoya las actividades de computación en la nube del gerente comercial del cliente de servicios en la nube, incluida la selección y compra de servicios, la gestión contable y la financiera relacionada con el uso de servicios en la nube, generalmente las capacidades comerciales se ofrecen a través de servicios en la nube.
    
      .col-lg-10.pos-relative(data-aos="fade-right")
        .tarjeta-avatar-b.pos-relative.mb-5
          img(src='@/assets/curso/images/tema1/ico_10.svg', alt="", style="width:100px; display:block;").tj
          .tarjeta.color-tarjeta-1
            .py-4.px-md-0.px-3
              h4 La función comercial
              ...
              p.mb-0 Esto incluye funciones para la administración de identidades y perfiles de usuarios, el monitoreo de la actividad y el uso del servicio, el manejo de eventos y la notificación de problemas.
    ...
    .row.justify-content-center.align-items-center.mb-5.px-md-5
      .col-12.col-md-4.col-lg-6.col-xl-7(data-aos="fade-right")
        p.mb-0 Los componentes funcionales de la capa de acceso incluyen:

        LineaTiempoD.color-acento-contenido.mt-5
          p(numero="1" titulo="Control de acceso") Se debe proporcionar control de acceso a los servicios en la nube, los recursos de los que dependen y las funciones de control relacionadas, por tanto, este componente funcional limita el uso a los servicios particulares de los usuarios, implica la autenticación de un usuario a través de la plataforma de acceso, validación de credenciales, seguida de la autorización de este usuario autenticado para utilizar servicios específicos, es fundamental en este componente la gestión de identidades.

          p(numero="2" titulo="Acceso al servicio") Proporciona acceso a los servicios en la nube ofrecidos por el proveedor de servicios.
            
          p(numero="3" titulo="Acceso comercial") Este componente funcional proporciona acceso a las capacidades empresariales ofrecidas por el proveedor y adquiridas por el cliente, incluye sistemas y mecanismos de soporte de tipo empresarial.

          p(numero="4" titulo="Administración acceso") Proporciona acceso a las capacidades de administración ofrecidas por el proveedor, son las interfaces de gestión y administración de los accesos con que cuenta cada usuario al adquirir un servicio en la nube.

          p(numero="5" titulo="Acceso al desarrollo") Capacidades dentro del sistema ofrecidas por el proveedor de servicios en la nube, que respalda el desarrollo, la prueba y el mantenimiento de las implementaciones de servicios adquiridos.
  ...
  .container.bg-white.p-4.p-md-5.container-bottom
    ...
    p.mb-4  Los Componentes funcionales de la capa de servicio incluyen: 

    SlyderF.mb-5(columnas="col-lg-6 col-xl-4")(data-aos="fade")
      .tarjeta.sp1.p-3
        .row.justify-content-center.mb-3
          .col-6
            img.mb-3(src='@/assets/curso/images/tema1/ico_11.svg' alt='Volver arriba' style="width: 115px")
        h3.aling.text-white Capacidades de servicio
        p.aling.text-white Consiste en el software necesario para implementar el servicio ofrecido a los proveedores de servicios cloud, despliega y entrega la interfaz del servicio, es decir, la interfaz ofrecida a los clientes, independientemente del modo o tipo de implementación del servicio.  
      .tarjeta.sp1.p-3
        .row.justify-content-center.mb-3
          .col-6
            img.mb-3(src='@/assets/curso/images/tema1/ico_12.svg' alt='Volver arriba' style="width: 115px")
      ...
      .tarjeta.sp1.p-3
        .row.justify-content-center.mb-3
          .col-6
            img.mb-3(src='@/assets/curso/images/tema1/ico_13.svg' alt='Volver arriba' style="width: 115px")
        h3.aling.text-white Capacidades de administración
        p.aling.text-white Suministra capacidades para acceder a la función de administración relacionada con la prestación de servicios en la nube.
      .tarjeta.sp1.p-3
        .row.justify-content-center.mb-3
          .col-6
            img.mb-3(src='@/assets/curso/images/tema1/ico_14.svg' alt='AvatarTop' style="width: 115px")
        h3.aling.text-white Orquestación de servicio
        p.aling.text-white Proporciona coordinación, agregación y composición de múltiples componentes de servicios para brindar el servicio en la nube.
  ...
  .container.bg-white.p-4.p-md-5.fondo-15
    .row.align-items-center.mb-4.p-3
    ...
    .row.justify-content-center
      ...
      .col-12.col-md-4.col-lg-12.col-xl-12.mb-3(data-aos="fade")
  ...
  .container.bg-white.p-4.p-md-5.container-bottom
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-12.col-md-4.col-lg-12.col-xl-12(data-aos="fade")
        .cajon.color-custom.p-3.px-md-4
          p.mb-0 Una auditoría generalmente produce como resultado final un informe de auditoría que incluye algún tipo de recomendación o aval de certificación final y que se pone a disposición de las partes de los acuerdos de servicios asociados, la auditoría en sí depende de la disponibilidad de datos y pruebas que sostienen la evidencia en el uso, el entorno, la disponibilidad y el rendimiento de los servicios y los recursos asociados.
        ...
        .tema1-1
          .bloque-texto-a.color-custom-3.p-4.p-md-5.mb-5 
            .row.m-0.align-items-center.justify-content-between
              .col-lg-8(data-aos="fade-right")
                .bloque-texto-a__texto.p-3.px-md-4
                  p.text-bold Este aspecto se refiere a la propiedad de poder garantizar que los servicios estén siempre disponibles, o accesibles y utilizables en todo momento a pedido de una entidad autorizada. La “entidad autorizada” suele ser un cliente de servicios en la nube.
                  p.text-bold La implicación de este aspecto se integra dentro de otros aspectos que se explican de forma más amplia como el de la seguridad y del gobierno, tal y como se puede ver más adelante.
                  p.text-bold.mb-0 La disponibilidad como tal en los servicios en nube es un aspecto que debe ser concretizado en los SLA asociados.
              .col-lg-4.mb-4.mb-lg-0(data-aos="fade-left")
                figure
    ...
    .row.justify-content-center.align-items-center.mb-3
      .col-12.col-md-4.col-lg-12.col-xl-12(data-aos="fade")
        .cajon.color-custom-2.p-3.px-md-4
          p.mb-0 Se debe diferenciar los mantenimientos desarrollados por cliente de los desarrollados por el proveedor de servicios en la nube especialmente dependerá del tipo de servicio al cual se le programa, por ejemplo. para el caso de un servicio SaaS prácticamente todas las acciones de mantenimiento se espera que sean realizadas por el proveedor mientras que, en el caso de los servicios IaaS y PaaS, los componentes de la aplicación pertenecen al cliente y consecuentemente será el responsable del mantenimiento de esos componentes que podrá realizar con personal propio o mediante un partner asociado que proporcione servicios gestionados en su portafolio. 
          ...
          .row.m-0.align-items-center.justify-content-between
            .col-lg-8(data-aos="fade-right")
              .bloque-texto-a__texto.p-4
                ...
                p.mb-0 Es importante que el servicio reciba una etiqueta de nueva versión cuando se realiza el mantenimiento de un servicio en la nube para poder aplicar actividades eficaces de control de versiones de manera adecuada y según procesos garantistas basados en buenas prácticas ampliamente conocidas y aplicadas como modelos (ITIL).
            .col-lg-4.mb-4.mb-lg-0(data-aos="fade-left")
              figure
                img.px-md-4(src='@/assets/curso/images/tema1/img_29.png' alt='')

    p.mb-5 Por ejemplo, cuando se realicen cambios significativos en un servicio de una versión a una nueva, la versión más antigua del servicio debería estar disponible en paralelo con la nueva versión durante un periodo de tiempo acordado.

  
    h3(data-aos="fade-right") Portabilidad
    ...
    .row.justify-content-center.align-items-center.mb-5.fondo-3.p-3
      .col-lg-12.mx-auto.mb-5
        .tema1-1 
          .bloque-texto-a.color-custom-1.p-3.p-md-5
            .row.m-0.align-items-center
              .col-lg-3.mb-4.mb-lg-0(data-aos="fade-right")
                figure
                  img(src='@/assets/curso/images/tema1/img_30.png' alt='')
              .col-lg-9
        ...
        p.px-4 En ambos casos, existe un aspecto importante a considerar relacionado con la portabilidad de los metadatos relacionados con los componentes de la aplicación que proporcionan información sobre las relaciones de los componentes de la aplicación y sobre la infraestructura requerida asociada, por ejemplo, la configuración de balanceo de cargas o la configuración del <i>firewall.</i>

        p.px-4 De forma similar a la pérdida de la tabla de indexación de una base de datos relacional, la conservación de los metadatos en un proceso de portabilidad es fundamental para poder materializarla.

    
    h3(data-aos="fade-right") Protección de la información de la identidad personal
    
    .row.justify-content-center.align-items-center.mb-4
      .col-12.col-md-4.col-lg-12.col-xl-12(data-aos="fade")
        .cajon.color-custom.p-3.px-md-4
          p.mb-0 Los proveedores deben proteger la recopilación, el procesamiento, la comunicación, el uso y la eliminación segura, adecuada y consistente de la información personal identificable en relación con los servicios en la nube.
          p.mb-3 De acuerdo con las pautas establecidas, uno de los imperativos comerciales claves de una organización es garantizar la protección de datos personales. Aunque la computación en la nube proporciona una solución flexible para recursos compartidos y que incluye <i>software</i>  e información, también plantea desafíos adicionales de confidencialidad para los clientes que utilizan servicios en la nube y también para los proveedores.
        ...
        .bloque-texto-a.color-custom-3.p-4.mb-5 
          .row.m-0.align-items-center.justify-content-between
            ...
            .col-lg-3.mb-4.mb-lg-0(data-aos="fade-left")
              ...
              figure
                img(src='@/assets/curso/images/tema1/img_31.png' alt='' style="width:220px; display:block; margin:0 2rem;")

    
    h3(data-aos="fade-right") Resiliencia 
    ...
    .h3(data-aos="fade-right") Reversibilidad
