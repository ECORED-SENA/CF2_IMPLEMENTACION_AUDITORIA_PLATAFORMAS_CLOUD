...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    #t_1_1.titulo-segundo
      .h4 1.1 Tipos de servicios y modelos Cloud 
    ...
    .row.justify-content-center.align-items-center.fondo-1.mb-3
      ...
      .col-4.mb-4.d-flex
        .tarjeta--sencilla.p-4
          ...
          h3.aling.mb-4  Idas
            p.mb-0 Proporciona el hardware virtualizado en forma de máquinas virtuales en diferentes instancias de Sistemas operativos o Contenedores generalmente docker, incluye de igual manera el networking.
    ...
    .row.justify-content-center.align-items-center.fondo-3.mb-3
      .col-12.col-md-4.col-lg-6.col-xl-7
        p.mb-0 En términos generales los servicios más importantes son: servicios de computo, almacenamiento y redes, a continuación de mencionan de manera general algunos de los servicios más comunes o de mayor demanda por parte de los clientes:

        LineaTiempoD.color-acento-contenido.mt-5
          p.text-small.color.line(numero="1" titulo="Servicios informáticos") Generalmente son los servicios más importantes, representan la columna vertebral para los clientes, acá se encuentra regularmente el acceso a máquinas virtuales, instancias de distintos tipos, contenedores docker, clúster de alto rendimiento, normalmente usados para el alojamiento de aplicaciones y servicios web.

          p.text-small(numero="2" titulo="Servicios de almacenamiento") Este tipo de servicio ofrece una variedad que va desde el almacenamiento de objetos y archivos, bases de datos SQL tradicionales como MySQL, PostgreSQL, Oracle, SQLServer o bases de datos NOSQL.
          ...
          .row.m-0.align-items-center.justify-content-between
            .col-lg-8
              .bloque-texto-a__texto.p-4
                p.mb-3 Cada proveedor de servicios cloud dispone de una arquitectura propia como elemento diferenciador del resto de competidores de mercado y/o para adaptarse mejor a la evolución de sus propios servicios tradicionales y necesidades de sus clientes actuales y potenciales. 
    ...
    TabsB.color-acento-contenido.mb-5
      .py-4.py-md-5(titulo="Capa de usuario" :icono="require('@/assets/curso/images/tema1/ico_tab_1.svg')")
        .row
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/images/tema1/img_5.svg', alt='' style="width:400px; display:block; margin:auto 3rem;")
      ...
      .py-4.py-md-5(titulo="Capa de acceso" :icono="require('@/assets/curso/images/tema1/ico_tab_2.svg')")
        .row
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/images/tema1/img_6.svg', alt='' style="width:400px; display:block; margin:auto 3rem;")
      ...
      .py-4.py-md-5(titulo="Capa de servicios" :icono="require('@/assets/curso/images/tema1/ico_tab_3.svg')")
        .row
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/images/tema1/img_7.svg', alt='' style="width:400px; display:block; margin:auto 3rem;")

      .py-4.py-md-5(titulo="Capa de servicios" :icono="require('@/assets/curso/images/tema1/ico_tab_4.svg')")
        .row
          .col-md-6.mb-4.mb-md-0
            h4 Capa de servicios
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/images/tema1/img_8.svg', alt='' style="width:400px; display:block; margin:auto 3rem;")
      ...
      SlyderA(tipo="b")
        .row.justify-content-center.align-items-center.p-4
          .col-10.col-lg-5.col-md-5
            p.mb-5 Capacidades de los sistemas de soporte empresarial (catálogo de productos, facturación y gestión financiera).
        ...
        .row.justify-content-center.align-items-center
          .col-11.col-lg-5.col-md-5.mb-4.mb-md-0
            figure
              img(src='@/assets/curso/images/tema1/img_10.svg', alt='').m-auto
        ...
        .row.justify-content-center.align-items-center
          .col-10.col-lg-4.col-md-5
            p.mb-5 Capacidades de los sistemas de seguridad (autenticación, autorización, auditoría, validación, cifrado).
        ...
        .row.justify-content-center.align-items-center
          .col-10.col-md-5
            figure
              img(src='@/assets/curso/images/tema1/img_12.svg', alt='', style="width:350px; display:block; margin:0 1rem;")

          .col-11.col-md-5.mb-4.mb-md-0
            p.mb-0 Capacidades de integración (vinculación de diferentes componentes para lograr la funcionalidad requerida).
            

        .row.justify-content-center.align-items-center
          .col-10.col-lg-5.col-md-5
            p.mb-5 Capacidades de apoyo al desarrollo (que implican la creación, prueba y gestión del ciclo de vida de servicios y componentes de servicio)
          .col-11.col-lg-6.col-md-5.mb-4.mb-md-0
            figure
    ...
    #t_1_3.titulo-segundo
      .h4 1.3 Relaciones entre la vista del usuario y la funcionalidad
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-12.col-md-8.col-lg-12.col-xl-12 
        .cajon.color-custom.p-3
          p Una actividad de computación en la nube se define como una búsqueda o un conjunto de tareas específicas, las cuales deben tener un propósito y generar uno o más resultados y se llevan a cabo utilizando componentes funcionales.
    ...
    .row.mb-5
      .col-lg-3.d-flex
        .tarjeta--sencilla-1.p-4
          ...
          h3.aling.mb-4 Cliente
            p.aling.mt-3 Cliente de servicio en la nube (CSC): usuario o empresa que mantiene una relación comercial con el propósito de utilizar servicios en la nube ofertados por un proveedor.
      ...
      .col-lg-3.d-flex
        .tarjeta--sencilla-1.p-4
          ...
          h3.aling Proveedor
            p.aling.mt-3 Proveedor de servicios en la nube (CSP): es la empresa quien ofrece y pone a disposición de los clientes un conjunto de servicios, en todas las categorías a fin de dar solución y respuesta a cada cliente de acuerdo a sus particularidades o necesidades.
      ...
      .col-lg-3.d-flex
        .tarjeta--sencilla-1.p-4
          ...
          h3.aling Partner
            p.aling.mt-3 Partner de servicios en la nube (CSN): parte que se dedica a proporcionar soporte o asistencia a las actividades del CSP, del CSC o de ambos.
      ...
      .col-lg-3.d-flex
        .tarjeta--sencilla-1.p-4
          ...
          h3.aling Subroles Asociados
            p.aling.mt-3 Un sub-rol es un subconjunto de las actividades de computación en la nube para un rol determinado. Diferentes sub-roles pueden compartir las actividades de computación en la nube asociadas con un rol determinado.

    .row.mb-5.ps-2.fondo-3
      ...
      .row.mb-5.ps-2
        ...
        .row.justify-content-center.align-items-center.my-5
          .col-12.col-md-4.col-lg-6.col-xl-6
            .cajon.color-custom.p-3
              p.mb-3 Los servicios en la nube son los elementos esenciales de la computación en la nube, son los diferentes tipos de capacidades ofertados por un proveedor de servicios de Cloud, en la actualidad son muchos los diferentes tipos de servicios ofertados, pero de acuerdo al estándar ISO/IEC 17788, son tres los tipos de servicios o capacidades proporcionados por el servicio en la nube, estos son:

            LineaTiempoD.color-acento-contenido.mt-5
              p.text-small.color.line(numero="1" titulo="Aplicación") Se encuentra en la capa más alta, es un servicio ofrecido bajo demanada a través de multitenencia, es accesible por medio de un navegador web, el usuario no tiene control sobre ella, y posibilita la reducción de costos de soporte y mantenimiento.

              p.text-small(numero="2" titulo="Servicios se networking (Acceso a Redes)") Aquí, el proveedor proporciona la plataforma para el desarrollo de aplicaciones, así como su mantenimiento y gestión. Es decir, ofrece todo lo que se necesita para completar el ciclo de vida y despliegue de dichas aplicaciones o servicios web. El usuario carece de control sobre la infraestructura de almacenamiento o redes.
                
              p.text-small(numero="3" titulo="Infraestructura") En éste, el cliente adquiere del proveedor externo todos los recursos. Normalmente se lleva a cabo mediante una plataforma de virtualización. De los tres tipos de servicios, es el que mayor control otorga al usuario y, por ende, el que tiene mayor complejidad de uso.
          ...
          p.mb-0 Estos servicios fueron descritos en el componente formativo denominado “Generalidades de la Computación en la Nube” se invita a revisarlo, para recordar o profundizar estas temáticas.
    ...
    p.mb-3 Existen algunos aspectos que se llaman transversales, porque se aplican a múltiples roles individuales o componentes funcionales, por ejemplo, la seguridad.            
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
      ...
      div.row(titulo="Capa de recursoso")
        .col-md-6.mb-4.mb-md-0
          h3 Capa de recursos
        ...
        .row.justify-content-center.mb-0
          .col-sm-6.col-lg-3.mb-4.mb-lg-0.btn.mb-5
            a(href="#1", title="Capa de usuario") 
              figure
                img(src='@/assets/curso/images/tema1/ico_menu_1.svg' alt='1')
              .indicador-click(v-if="mostrarIndicador")
          .col-sm-6.col-lg-3.mb-4.mb-lg-0.btn.mb-5
            a(href="#2", title="Capa de acceso") 
              figure
                img(src='@/assets/curso/images/tema1/ico_menu_2.svg' alt='1')
              .indicador--click(v-if="mostrarIndicador")      
          .col-sm-6.col-lg-3.mb-4.mb-lg-0.btn.mb-5
      ...
      .row.justify-content-center.align-items-center.mb-3.fondo-6
        .col-lg-10
          .tarjeta-avatar-b.mb-5
            img(src='@/assets/curso/images/tema1/ico_8.svg', alt="", style="width:100px; display:block; margin:0 auto;").tj
            .tarjeta.color-tarjeta-1
              .p-4
                h4 La función de usuario
                p.mb-3 Este componente funcional da soporte al usuario para poder acceder y utilizar los servicios en la nube. 
        ...
        .col-lg-10
          .tarjeta-avatar-b.mb-5
            img(src='@/assets/curso/images/tema1/ico_9.svg', alt="", style="width:100px; display:block; margin:0 auto;").tj
            .tarjeta.color-tarjeta-1
              .p-4
        ...
        .col-lg-10
          .tarjeta-avatar-b.mb-5
            img(src='@/assets/curso/images/tema1/ico_10.svg', alt="", style="width:100px; display:block; margin:0 auto;").tj
            .tarjeta.color-tarjeta-1
              .p-4
                h4 La función comercial
    ...
    SlyderF.mb-5(columnas="col-lg-6 col-xl-4")
      .tarjeta.sp1.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/images/tema1/ico_11.svg')
        h2.aling.text-white Capacidades de servicio
      ...
      .tarjeta.sp1.p-4
        ...
        h2.aling.text-white Capacidades comerciales
        p.aling.text-white Proporciona un conjunto de capacidades para acceder a la función comercial relacionada con la prestación de servicios en la nube. La función empresarial en sí está contenida dentro de los componentes funcionales de los sistemas de soporte empresarial.

      .tarjeta.sp1.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/images/tema1/ico_13.svg')
        h2.aling.text-white Capacidades de administración
      ...
      .tarjeta.sp1.p-4
        ...
        h2.aling.text-white Orquestación de servicio
    ...
    #t_1_4_1.titulo-segundo
      .h4 1.4.1	Auditabilidad 
    ...
    .row.align-items-center.fondo-3.mb-5
      ...
      #t_1_4_2.titulo-segundo
        .h4 1.4.2	Disponibilidad
        ...
        .tema1-1
          .bloque-texto-a.color-custom-3.p-4.p-md-5.mb-5 
            .row.m-0.align-items-center.justify-content-between
              .col-lg-8
                .bloque-texto-a__texto.p-4
                  p.mb-3 Este aspecto se refiere a la propiedad de poder garantizar que los servicios estén siempre disponibles, o accesibles y utilizables en todo momento a pedido de una entidad autorizada. La “entidad autorizada” suele ser un cliente de servicios en la nube.

                  p.mb-3 La implicación de este aspecto se integra dentro de otros aspectos que se explican de forma más amplia como el de la seguridad y del gobierno, tal y como se puede ver más adelante.
    ...
    #t_1_4_3.titulo-segundo
      .h4 1.4.3	Interoperabilidad
    
    p.mb-3 Este aspecto en el contexto de la computación en nube se refiere a la capacidad de un cliente de servicios de computación en la nube para interactuar e intercambiar información de acuerdo con un método prescrito y obtener resultados predecibles. En el siguiente vídeo se podrá conocer más a este respecto.

    figure.mb-5
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/2L91WMqw96A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)

    #t_1_4_4.titulo-segundo
      .h4 1.4.4	Control de versiones
    ...
    #t_1_4_5.titulo-segundo
      .h4 1.4.5	Portabilidad
    ...
    #t_1_4_6.titulo-segundo
      .h4 1.4.6	Protección de la información de la identidad personal
    ...
    #t_1_4_7.titulo-segundo
      .h4 1.4.7	Resiliencia 

    p.mb-3 Este aspecto se refiere a la capacidad de un sistema para proporcionar y mantener un nivel aceptable de servicio ante fallas (involuntarias, intencionales o causadas naturalmente) que afecten el funcionamiento normal.
    ...
    .row.mb-5
      ...
      .col-md-6.col-lg.mb-5.mb-lg-0
        .tarjeta-avatar
          ...
          .tarjeta.sp1
            .p-4
              p.aling.text-white mEstos procesos, pueden incluir fallas de hardware, comunicaciones y/o software y pueden ocurrir como incidentes aislados o en combinación, incluyendo fallas en serie en forma de efecto dominó. 
    ...
    #t_1_4_8.titulo-segundo
      .h4 1.4.8	Reservisibilidad
