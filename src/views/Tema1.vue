            ...
            .row.m-0.align-items-center
              .col-lg-8(data-aos="fade-right")
                .bloque-texto-a__texto
                  p.mb-0.p-3 #[b Cada proveedor de servicios #[i cloud]  dispone de una arquitectura propia como elemento diferenciador del resto de competidores de mercado y/o para adaptarse mejor a la evolución de sus propios servicios tradicionales y necesidades de sus clientes actuales y potenciales. #[br] Si bien existen diferencias marcadas entre las nubes públicas o privadas, a continuación se mencionan los diferentes componentes funcionales de alto nivel presentes en una arquitectura de nube en términos generales o genérica.]
              ...
              .row.m-0.align-items-center.justify-content-between
                .col-lg-9(data-aos="fade-right")
                  .bloque-texto-a__texto.p-5
                    p.text-small.mb-2 Este aspecto se refiere a la propiedad de poder garantizar que los servicios estén siempre disponibles, o accesibles y utilizables en todo momento a pedido de una entidad autorizada. La “entidad autorizada” suele ser un cliente de servicios en la nube.

                    p.text-small.mb-2 La implicación de este aspecto se integra dentro de otros aspectos que se explican de forma más amplia como el de la seguridad y del gobierno, tal y como se puede ver más adelante.

                    p.text-small La disponibilidad como tal en los servicios en nube es un aspecto que debe ser concretizado en los SLA asociados.
                .col-lg-3.mb-4.mb-lg-0(data-aos="fade-left")
                  figure
                   img(src='@/assets/curso/images/tema1/img_26.png' alt='' style="width:220px; display:block; margin:0 auto;")
